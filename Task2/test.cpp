...
extern "C"
{
    ...
    void _fdct (float * source, float * destination, int count);
    void _idct (float * source, float * destination, int count);
...
void test__idct8 (float * src, float * dst, int count)
{
...
//    print(src);
    ...
    std::cout << "Middle: " << sec.count() << std::endl << std::endl;
//    print(dst);
    
    std::chrono::high_resolution_clock::time_point start1 = std::chrono::high_resolution_clock::now();
    _idct(dst, src, matrices);
    _idct(dst, src, matrices);
    _idct(dst, src, matrices);
    _idct(dst, src, matrices);
    _idct(dst, src, matrices);
    std::chrono::duration<double> sec1 = std::chrono::high_resolution_clock::now() - start1;
    
    std::cout << "After: " << sec1.count() << std::endl << std::endl;
//    print(src);
